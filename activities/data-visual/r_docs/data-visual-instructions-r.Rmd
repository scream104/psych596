...
- if you intend to put multiple plots together to make a figure (e.g., in Powerpoint, Adobe Illustrator, Inkscape, ...) it is recommended to use the \*.svg file type to preserve the resolution of the chart components.  
