...
#### Interpretation:
- First, notice there is no R<sup>2</sup) value. This is because there is no universally agreed method for computing it, but you can compute something similar called Pseudo-R<sup>2</sup) if you want (e.g., see documentation for the [DescTools Package](https://www.rdocumentation.org/packages/DescTools/versions/0.99.41/topics/PseudoR2))

- The "Analysis of Deviance Table" includes 
