...
- install the required packages: 
    ...
    - `install.packages("optimx")` *note: students with an R version newer (higher) than 4.2.1 may not be able to install this package - this is only needed for one step so you can skip it   
