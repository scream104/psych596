---
title: "Activity-Import data and examine distributions - no code"
author: "JB"
...
#### 2.2 Import the ice bucket data into R
...
#### 4.0 Import in NHANES data - insert the code in the chunk you created earlier called *"Step2-load-datasets"*
...
-   Re-calculate the Shapiro-Wilk. What does it tell you?
...
5.1.1 Import the text file into a new dataframe/tibble (write the code in the original *Step2-load-dataset* code chunk) - note that some values are "qns" which stands for "quantity not sufficient" and should be treated as missing values.
